...
class CustomPagination extends CApplicationComponent{
	...
	//$pagination->operators = array('table_alias.date_from'=>array('date_field','=>','date'));
	//here date_field is an identifier that , it will be treated as date field
	//here => is an operator
	//here date is a column Name
											$operator = $value[1];	
