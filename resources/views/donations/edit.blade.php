...
<div class="row">
   <div class="col-md-12 col-xs-12">
      <div class="x_panel">
         <div class="x_title">
             <h1 style="color: #000;font-size: 32px;">Update Donation</h1>
                <ul class="nav navbar-right panel_toolbox">
                  ...
                  <div class="x_content">
					...
					{!! Form::model($model, ['method' => 'PATCH','route' => ['donations.update', $model->id], 'files' => true]) !!}
              ...
              <div class="row">
                ...
                <input type="text" class="donar_name form-control" value="{{$model->donar->fname.' '.$model->donar->lname}}" placeholder="-- Please Search --">
                </div>
