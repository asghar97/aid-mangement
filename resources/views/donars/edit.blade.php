...
<div class="row">
   <div class="col-md-12 col-xs-12">
      <div class="x_panel">
         <div class="x_title">
             <h1 style="color: #000;font-size: 32px;">Update Donar</h1>
                <ul class="nav navbar-right panel_toolbox">
                  ...
                  <div class="x_content">
					...
					{!! Form::model($model, ['method' => 'PATCH','route' => ['donars.update', $model->id], 'files' => true]) !!}
              ...
              <div class="row">
                  ...
                  <img src="{{asset('public/images/donar/'.$model->image) }}" alt="Profile Image" width="60" height="60" style="border: 1px #000 solid" onerror="this.src='{{asset('public/images/users/not_found.png') }}'"/>
                  </div>
