...
class Expense extends Model
{
	...
	protected $fillable = [
        'id','donar_id','amount','currency','type','comment','location','date_added','status','created_at','updated_at','created_by'
    ];

	static function getValidationRules(){
    	$rules = [
		    'id' => 'required','donar_id' => 'required','amount' => 'required','currency' => 'required','type' => 'required','comment' => 'required','location' => 'required','date_added' => 'required','status' => 'required','created_at' => 'required','updated_at' => 'required','created_by' => 'required'
		];
		return $rules;
    }
