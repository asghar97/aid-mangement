...
class Donar extends Model
{
	...
	protected $fillable = [
        'id','fname','lname','address','city','country','phone','email','company','image','created_at','updated_at','status','created_by'
    ];

	static function getValidationRules(){
    	$rules = [
		    'id' => 'required','fname' => 'required','lname' => 'required','address' => 'required','city' => 'required','country' => 'required','phone' => 'required','email' => 'required','company' => 'required','image' => 'required','created_at' => 'required','updated_at' => 'required','status' => 'required','created_by' => 'required'
		];
		return $rules;
    }
